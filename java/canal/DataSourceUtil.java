...
public class DataSourceUtil {
	...
	public static ElasticsearchHttpFactory httpElasticsearch(){
		try {
			...
			ElasticsearchHttpFactory factory = new ElasticsearchHttpFactory();
			factory.init(servers, username, password);
			return factory;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public static ElasticsearchTransportFactory elasticsearch(){
		try {
			...
			String username = CanalConfig.getProperty("elasticsearch.cluster.username");
			String password = CanalConfig.getProperty("elasticsearch.cluster.password");
			ElasticsearchTransportFactory factory = new ElasticsearchTransportFactory();
			factory.init(clusterName, servers, username, password);
			return factory;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
